...
import { TrophyIcon, CrosshairIcon, TrendingUpIcon, GamepadIcon } from '../components/icons/Icons'
...
const DashboardPage = () => {
    ...
    const statItems = [
        ...
        { icon: <CrosshairIcon className='w-6 h-6' />, value: losses !== null ? String(losses) : 'N/A', label: 'Losses', color: 'text-red-400' },
        { icon: <TrendingUpIcon className='w-6 h-6' />, value: winRate ?? 'N/A', label: 'Win Rate', color: 'text-cyan-400' },
        { icon: <GamepadIcon className='w-6 h-6' />, value: total !== null ? String(total) : 'N/A', label: 'Total Games', color: 'text-blue-400' },
    ]
        ...
        <div className='container-main'>
            ...
            <main className='content-main flex items-center justify-center p-4 sm:p-8'>
                <div className='w-full max-w-2xl space-y-6'>
                    {/* Profile Card */}
                    <div className='border border-slate-700/50 in-[.light]:border-gray-200
                        bg-slate-800/50 in-[.light]:bg-white/80
                        backdrop-blur-sm rounded-2xl p-8 text-center space-y-4'>

                        {/* Avatar */}
                        <div className='flex justify-center'>
                            <div className='w-20 h-20 rounded-full bg-linear-to-r from-cyan-400 to-purple-600
