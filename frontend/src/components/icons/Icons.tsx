...
export const TrophyIcon = ({ className = 'w-5 h-5' }: IconProps) => (
    <svg className={className} fill='none' stroke='currentColor' viewBox='0 0 24 24'>
        <path strokeLinecap='round' strokeLinejoin='round' strokeWidth={2} d='M8 21h8m-4-4v4m0 0H8m4 0h4M5 3h14M5 3a2 2 0 00-2 2v1c0 2.5 1.5 4.5 3.5 5.5M5 3h14m0 0a2 2 0 012 2v1c0 2.5-1.5 4.5-3.5 5.5M12 13c-2.5 0-5-1.5-6.5-3.5M12 13c2.5 0 5-1.5 6.5-3.5M12 13v4' />
    </svg>
)
